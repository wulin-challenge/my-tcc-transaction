...
public class JdbcTransactionRepository extends CachableTransactionRepository {
	private Logger logger = Logger.getLogger(JdbcTransactionRepository.class);
    ...
    protected int doCreate(Transaction transaction) {
        ...
        try {
            ...
            builder.append("INSERT INTO " + getTableName() +
                    "(GLOBAL_TX_ID,BRANCH_QUALIFIER,TRANSACTION_TYPE,CONTENT,STATUS,RETRIED_COUNT,CREATE_TIME,LAST_UPDATE_TIME,VERSION,TRANSACTION_ID");
            ...
            stmt.setLong(10, findMaxTransactionId());
     ...
     * @return
     */
    protected long findMaxTransactionId() {
        Connection connection = null;
        PreparedStatement stmt = null;
        ResultSet resultSet = null;
        ...
        try {
            ...
            StringBuilder builder = new StringBuilder();
            builder.append("SELECT MAX(TRANSACTION_ID) AS MAX_TRANS_ID");
            ...
            if(resultSet.next()) {
            	...
            	if(transactionId>maxId.get()) {
            		maxId.set(transactionId);
            	}else {
