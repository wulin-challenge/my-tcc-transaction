...
public class TransactionController {
    ...
    public ModelAndView manager(@RequestParam(value = "domain", required = false) String domain,
        ...
        logger.info("query with domain:"+domain+",pageNum:"+pageNum);
    ...
    public CommonResponse<Void> reset(String domain, String globalTxId, String branchQualifier) {
        ...
        logger.info("request /retry/reset with domain: "+domain+" globalTxId: "+globalTxId+" branchQualifier:"+branchQualifier);
    ...
    public CommonResponse<Void> delete(String domain, String globalTxId, String branchQualifier) {
        ...
        logger.info("request /retry/delete with domain: "+domain+" globalTxId: "+globalTxId+" branchQualifier:"+branchQualifier);
    ...
    public CommonResponse<Void> confirm(String domain, String globalTxId, String branchQualifier) {
        ...
        logger.info("request /retry/confirm with domain: "+domain+" globalTxId: "+globalTxId+" branchQualifier:"+branchQualifier);
    ...
    public CommonResponse<Void> cancel(String domain, String globalTxId, String branchQualifier) {
        ...
        logger.info("request /retry/cancel with domain: "+domain+" globalTxId: "+globalTxId+" branchQualifier:"+branchQualifier);
