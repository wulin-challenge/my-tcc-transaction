package com.wulin.boot.dubbo.order.controller;
...
import com.wulin.boot.dubbo.order.service.AccountServiceImpl;
import com.wulin.boot.dubbo.order.service.PlaceOrderServiceImpl;
import com.wulin.boot.dubbo.order.vo.PlaceOrderRequest;
...
public class OrderController {
    ...
    public ModelAndView productDetail(@PathVariable long userId,
        ...
        mv.addObject("product", productRepository.findByProductId(productId));
    ...
    public RedirectView placeOrder(HttpServletRequest req,@RequestParam String redPacketPayAmount,
        ...
        return new RedirectView(req.getContextPath()+"/payresult/" + merchantOrderNo);
    }
